...
export default function TestEntry() {
    ...
    const handleSave = (e) => {
        ...
        alert('Test entry saved successfully!');
    };
            ...
            >
                ...
                <div className="bg-gradient-to-r from-fuchsia-600 to-purple-600 px-5 py-4 flex items-center justify-between text-white">
                    ...
                    <div className="flex items-center gap-4">
                        <button className="hover:bg-white/20 p-1.5 rounded-lg transition-colors"><RefreshCw size={18} /></button>
                        <button className="hover:bg-white/20 p-1.5 rounded-lg transition-colors"><Maximize2 size={18} /></button>
                    </div>
                </div>
                ...
                <form onSubmit={handleSave} className="p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-2 mb-6">
                        ...
                        <div>
                            ...
                            <SelectField label="Test Format" name="testFormat" value={formData.testFormat} onChange={handleChange} options={["Single", "Profile", "Group"]} />
                        </div>
